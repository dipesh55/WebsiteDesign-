    ...
    return this.each(function () {
      ...
      function o() {
        ...
        !n.nav ||
          ...
          "after" === n.nav ? O.append(L) : O.prepend(L),
          (M = L.find("." + k.navItem)));
      }
      function p() {
        if (n.nav) {
        ...
        I && (clearInterval(I), (I = !1)),
          J.each(function (c) {
            ...
            f.attr("class", function (a, b) {
              ...
              (d = f.outerWidth()),
              0 !== n.spacing && f.css("margin-right", d * n.spacing + "px"),
              (e = f.position().left),
              (P[c] = -1 * (e + d / 2 - H / 2)),
          ...
          return (
            "prev" === a
              ...
              : a !== c &&
                ...
                n.loop &&
                  b != Q &&
                  (b == J.length - 1 && Q != J.length - 2 && (Q = 0),
                  0 == b && 1 != Q && (Q = J.length - 1))),
            (K = J.eq(Q)),
            Q !== b && n.onItemSwitch && n.onItemSwitch.call(O, J[Q], J[b]),
            u(),
            O
          );
      }
      ...
      function z() {
        t(!0),
          O.hide().css("visibility", "").addClass(k.active).fadeIn(n.fadeIn);
      }
      function A() {
        if (
          ((G = O.find(n.itemContainer).addClass(k.container)),
          (J = G.find(n.itemSelector)),
          !(J.length <= 1))
        )
          return (
        ...
        if (n.touch) {
          ...
          a.on({
            ...
            "touchmove.flipster": function (a) {
              (a = a.originalEvent),
                (d = a.touches ? a.touches[0].clientX : a.clientX),
                (e = a.touches ? a.touches[0].clientY : a.clientY),
                (g = d - b),
                (f = e - c),
                Math.abs(g) > 30 && Math.abs(f) < 100 && a.preventDefault();
            },
      ...
      function E() {
        ...
        (a =
          !!n.style && "flipster--" + n.style.split(" ").join(" flipster--")),
          O.addClass(
            [
              k.main,
              i ? "flipster--transform" : " flipster--no-transform",
              a,
              n.click ? "flipster--click" : "",
            ].join(" ")
          ),
          n.start &&
            (Q = "center" === n.start ? Math.floor(J.length / 2) : n.start),
          v(Q);
        var b = O.find("img");
        if (b.length) {
          var c = 0;
